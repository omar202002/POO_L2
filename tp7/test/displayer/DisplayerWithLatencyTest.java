...
public class DisplayerWithLatencyTest {

  private static final int WIDTH = 5;
  private static final String MESSAGE = "abcd";

  protected DisplayerWithLatency displayer;

  @Before  // => la méthode init() est exécutée avant chaque méthode de test
  public void init() {
     this.displayer = new DisplayerWithLatency(WIDTH,3);
  }
  ...
  public static junit.framework.Test suite() {
     return new junit.framework.JUnit4TestAdapter(displayer.DisplayerWithLatencyTest.class);
  }
}
